          ...
          toast.success(
            <div>
              ...
              <p>
                ...
                {FormatNumber(invoice.GcInvoice.data.priceD)}USD,{" "}
              </p>
              <p>
                Garbage Collection Price(R):{" "}
                {FormatNumber(invoice.GcInvoice.data.priceR)}IRR,{" "}
              </p>
              <p>
                vessel Stoppage Price($):{" "}
                {FormatNumber(invoice.VsInvoice.data.priceD)}USD,{" "}
              </p>
              <p>
                vessel Stoppage Price(R):{" "}
                {FormatNumber(invoice.VsInvoice.data.priceR)}IRR,{" "}
              </p>
              <p>
                Sum Invoice Price($):{" "}
                {FormatNumber(invoice.icBill.SumInvoicePriceD)}USD,{" "}
              </p>
              <p>
                Sum Invoice Price(R):{" "}
                {FormatNumber(invoice.icBill.SumInvoicePriceR)}IRR,{" "}
              </p>
            </div>
          );
              ...
              <Form className="custom-background">
                ...
                <div className="row details">
                  <div className="col-6">
                    Voyage/vessel:
                    {
                      <span className="invoiceItem">
                        {voyageData.VoyageVessel}
                      </span>
                    }
                  </div>
                  <div className="col-6">
                ...
                <div className="row details">
                  <div className="col-4">
                    ...
                    {
                      <span className="invoiceItem">
                        {voyageData.Nationality}
                      </span>
                    }
                  </div>
                  <div className="col-4">
                    Flag:{" "}
                    {<span className="invoiceItem">{voyageData.Flag}</span>}
                  </div>
                  <div className="col-4">
                    Call-sign:{" "}
                    {<span className="invoiceItem">{voyageData.CallSign}</span>}
                  </div>
                </div>
                <div className="row details">
                  <div className="col-4">
                  ...
                  <div className="col-4">
                    ...
                    {
                      <span className="invoiceItem">
                        {voyageData.PreviousPort}
                      </span>
                    }
                  </div>
                  <div className="col-4">
                    Next port:{" "}
                    {<span className="invoiceItem">{voyageData.NextPort}</span>}
                  </div>
                </div>
                <div className="row details">
                  <div className="col-4">
                  ...
                  <React.Fragment>
                    ...
                    <div className="row details">
                      <div className="col-3">
                        ...
                        {
                          <span className="invoiceItem">
                            {FormatNumber(voyageData.gcPriceD)}
                          </span>
                        }
                      </div>
                      <div className="col-3">
