...
const VesselsPage = (props) => {
    ...
    editVesselInfo(parameters)
      .then((response) => {
        ...
        if (response.data.result) {
          ...
          const index = _(lstVessels).findIndex(
            (c) => c.vesselId === values.id
          );
      ...
      render: (text, record) => (
        <Space size="middle">
          <Button
            ...
            size="sm"
            onClick={() => handleEditVessel(record)}
          >
            <Edit2 size={16} />
          </Button>
        </Space>
    ...
    getVesselTypes()
      .then((res) => {
        if (res.data.result) {
          ...
          setState((prevState) => ({
            ...prevState,
            ListOfVesselTypes: res.data.data.map((item) => {
              return { label: item.VesselTypeName, value: item.VesselType };
            }),
          }));
        }
      })
  ...
  const handleEditVessel = (vesselData) => {
    const Vessel = {
      ..._(state.ListOfVessels)
        .filter((c) => c.vesselId === vesselData.vesselId)
        .first(),
    };
    const temp = {
      selectVesselType: {
    ...
    <React.Fragment>
      ...
      >
        <ModalHeader toggle={editToggle}>
          Edit Vessel: {state.currentRow.vesselName}
        </ModalHeader>
        <ModalBody>
          <Formik
                  ...
                  <Form>
                      ...
                      <Row>
                        <Col md="6">
                          <FormikControl
                            ...
                            selectedValue={state.currentRow.selectVesselType}
                            options={state.ListOfVesselTypes}
                            label="Vessel Type"
                            onSelectedChanged={handleVesselTypeSelectedChanged}
                          />
                        </Col>
                        <Col md="6">
                          <FormikControl
                            ...
                            selectedValue={state.currentRow.selectNationality}
                            options={state.ListOfNationalities}
                            label="Nationality"
                            onSelectedChanged={handleNationalitySelectedChanged}
                          />
                        </Col>
                      </Row>
                      <Row>
                        <Col md="6">
                          <FormikControl
                            ...
                            type="number"
                            label="vessel Length"
                            defaultValue={state.currentRow.vesselLength}
                          />
                        </Col>
                        <Col md="6">
                          <FormikControl
                            ...
                            className="ltr"
                            label="Num Of Bays"
                            defaultValue={state.currentRow.numOfBays}
                          />
                        </Col>
                      </Row>
                      <Row>
                        <Col md="6">
                          <FormikControl
                            ...
                            defaultValue={state.currentRow.activeCraneQty}
                          />
                        </Col>
                        <Col md="6">
                          <FormikControl
                            ...
                            className="ltr"
                            label="Gross Tonage"
                            defaultValue={state.currentRow.grossTonage}
                          />
                        </Col>
                      </Row>
                      <Row>
                        <Col md="6">
                          <FormikControl
                            ...
                            className="ltr"
                            label="Call Sign"
                            defaultValue={state.currentRow.callSign}
                          />
                        </Col>
                        <Col md="6">
                          <FormikControl
                            control="customSelect"
                            name="selectFlag"
                            selectedValue={state.currentRow.selectFlag}
                            options={state.ListOfFlags}
                            label="Flag"
                            onSelectedChanged={handleFlagSelectedChanged}
                          />
                        </Col>
                      </Row>
                    </div>
                    <div className="form-actions center">
                      ...
                      <Button
                        color="warning"
                        type="button"
                        onClick={handleCancelEditVessel}
                      >
                  ...
                  <Form>
                    ...
                    <div className="form-actions center">
                      ...
                      <Button
                        color="warning"
                        type="button"
                        onClick={handleCancelCreateVessel}
                      >
                        <X size={16} color="#FFF" /> Cancel
                      </Button>
                    </div>
